namespace FiapCloundGames.API.Domain.Resources
{
    public static class MensagensDominio
    {
        ...
        public static string UsuarioEmailAtualizaDiferente = "O novo email do usuário deve ser diferente do email antigo.";
        ...
        public static string UsuarioObrigatorio = "O usuário é obrigatório.";   
